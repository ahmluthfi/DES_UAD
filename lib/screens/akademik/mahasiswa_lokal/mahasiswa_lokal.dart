...
import 'package:des_uad/screens/widgets/card_title_sub_menu_akademik.dart';
    ...
    return Scaffold(
      ...
      body: BodySubMenuAkademik(
        ...
        children: [
          ...
          BaseContainer.styledSubMenuAkademik(
            children: const [
              CardTitleSubMenuAkademik(title: 'Tren Mahasiswa Lokal'),
            ],
          ),
          kGap16,
          BaseContainer.styledSubMenuAkademik(
            children: const [
              CardTitleSubMenuAkademik(title: 'Persebaran PMB'),
            ],
          ),
        ],
      ),
