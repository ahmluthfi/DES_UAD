...
final class SdmJumlahDosenTendikLoaded extends SdmJumlah {
  final DataJumlahDosen dataDosen;
  final DataJumlahTendik dataTendik;
  SdmJumlahDosenTendikLoaded(this.dataDosen, this.dataTendik);
}
